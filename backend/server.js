...
app.get("*", (req, res) => {
  res.status(404).json({
    message:
      "Not found. This is a backend API server. Please access the frontend at http://localhost:3000",
...
app.listen(PORT, HOST, () => {
  ...
  if (HOST === "0.0.0.0") {
    console.log(
      `Server also accessible via your network IP address on port ${PORT}`,
    );
  }
});
