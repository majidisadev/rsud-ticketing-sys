  ...
  return (
    ...
    >
      ...
      <section
        ...
        aria-label="Grafik masalah hari ini dan bulan ini"
      >
        <Card
          ref={pieCardRef}
        ...
        >
          <CardHeader>
            <CardTitle className="text-lg">
              Jumlah Masalah Bulan Ini (per Tanggal)
            </CardTitle>
          </CardHeader>
          <CardContent>
            <ResponsiveContainer width="100%" height={300}>
              <LineChart
                data={monthlyData}
                aria-label="Grafik garis jumlah masalah per tanggal"
              >
      ...
      >
        <CardHeader>
          <CardTitle className="text-lg">
            Jumlah Masalah 12 Bulan Terakhir (per Bulan)
          </CardTitle>
        </CardHeader>
        <CardContent>
          <ResponsiveContainer width="100%" height={400}>
            <BarChart
              data={yearlyData}
              aria-label="Grafik batang jumlah masalah per bulan"
            >
              <CartesianGrid strokeDasharray="3 3" stroke="#e5e7eb" />
              <XAxis dataKey="month" />
              <YAxis />
